...
const AccessCodeDialog = ({ isOpen, onClose, onSave, currentCode }: AccessCodeDialogProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-white border-[#e9edee]">
        <DialogHeader>
          <DialogTitle className="text-2xl text-[#3f3c40]">Alterar Código de Acesso</DialogTitle>
          <DialogDescription className="text-xl text-[#4F85A6]">
            Defina um novo código de acesso para os professores
          </DialogDescription>
        </DialogHeader>
        <div className="py-4">
          <label className="text-lg font-medium text-[#3f3c40] block mb-2">Código de Acesso</label>
          <Input
            value={code}
...
export default function AdminDashboard() {
  const [accessCodeDialog, setAccessCodeDialog] = useState<{ isOpen: boolean; code: string }>({
    isOpen: false,
    code: "PROF2024",
  })
  return (
          ...
          <div className="container mx-auto p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <ButtonAdm
                  onClick={() => setAccessCodeDialog({ ...accessCodeDialog, isOpen: true })}
            ...
            <Tabs defaultValue="students" className="space-y-6">
              <TabsList className="grid w-full grid-cols-3 bg-white border border-[#e9edee]">
                <TabsTrigger value="students" className="data-[state=-white text-base text-[#3f3c40] px-1 py-0.5">
                  Alunos
                </TabsTrigger>
                <TabsTrigger
                  value="professors"
            ...
            <AccessCodeDialog
              ...
              onClose={() => setAccessCodeDialog({ ...accessCodeDialog, isOpen: false })}
              onSave={(newCode) => setAccessCodeDialog({ isOpen: false, code: newCode })}
