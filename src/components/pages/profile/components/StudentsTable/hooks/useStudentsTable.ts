    ...
    const handleDeleteUsers = useCallback(async () => {
        ...
        try {
            ...
            const message = selectedUsers.length === 1
                ...
                : `${selectedUsers.length} alunos excluídos com sucesso!`;
            ...
            enqueueSnackbar("Erro ao deletar alunos.", {
                variant: "error",
                autoHideDuration: 2500,
                anchorOrigin: { vertical: "bottom", horizontal: "right" },
            });
        ...
        (user: GenericUserInfo) => {
            const action = async (userId: string) => {
                try {
                    ...
                    enqueueSnackbar("Aluno excluído com sucesso!", {
                        variant: "success",
                        autoHideDuration: 2500,
                        anchorOrigin: { vertical: "bottom", horizontal: "right" },
                    });
                    ...
                    enqueueSnackbar("Erro ao excluir aluno.", {
                        variant: "error",
                        autoHideDuration: 2500,
                        anchorOrigin: { vertical: "bottom", horizontal: "right" },
                    });
