...
import { Home, Upload, Medal, HelpCircle } from "lucide-react"
...
export default function NavStudent({ children }: Props) {
  const [isOpen, setIsOpen] = useState(false)

  const navLinks = [
    { href: "#", label: "Home", icon: Home },
    { href: "#", label: "Enviar Exercício", icon: Upload },
        ...
        <div className="flex flex-col max-h-screen">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="lg:hidden flex items-center justify-between w-full">
              ...
              <div className="text-lg font-semibold lg:hidden">Student Portal</div>
            </div>
