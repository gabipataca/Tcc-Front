...
data.sort((a, b) => {
    ...
    if(aCount === bCount) { // Use === para comparação estrita
        ...
        <NavRanking>
            <TableContainerMui component={TableContainer}>
                <Table>
                    ...
                    <TableBody>
                        {data.map((rowData, idx) => ( // Renomeado 'data' para 'rowData' para evitar conflito com a constante 'data' global
                            <TableRow key={`${rowData.group}-${idx}`}>
                                ...
                                <TableCell key={`${rowData.total}-${idx}`}>
                                    {rowData.total}
                                </TableCell>
                            </TableRow>
                        ))}
