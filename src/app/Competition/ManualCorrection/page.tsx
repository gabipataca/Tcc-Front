...
export default function ManualCorrection() {
    ...
    return (
      <div className="bg-gray-200 flex-1 flex">
        <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col min-h-full ">
            {/* Título da página */}
            <div className="text-center mb-6">
                <h1 className="text-2xl font-bold text-[#4F85A6] mb-2">
                    Correção Manual de Exercícios
                </h1>
                <p className="text-gray-600">
                    Revise e avalie manualmente as submissões dos exercícios das
                    equipes
                </p>
            </div>

            {/* Tabela de submissões */}
            <Card className="shadow-lg mb-4  flex flex-col">
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="bg-[#4F85A6] hover:bg-[#4F85A6]">
                                    ...
                                    <TableHead className="text-white font-semibold text-center min-w-[200px]">
                                        Ações
                                    </TableHead>
                                </TableRow>
                            </TableHeader>
