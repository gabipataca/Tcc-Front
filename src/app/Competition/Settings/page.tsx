...
const EditMarathonContent: React.FC = () => {
  const {
    marathonName,
    setMarathonName,
    startDate,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 md:p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg border-0 overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            />
            <p className="text-xs text-slate-500 -mt-4">Este valor não pode ser alterado após a criação da maratona</p>
          </div>
        </div>
      ...
      <Dialog open={showConfirmDialog} onClose={() => setShowConfirmDialog(false)} maxWidth="sm" fullWidth>
        <DialogTitle sx={{ color: "#4F85A6", fontWeight: "bold" }}>Finalizar Maratona</DialogTitle>
        <DialogContent>
          <p style={{ color: "#333", fontSize: "16px" }}>Tem certeza que deseja FINALIZAR esta maratona agora?</p>
        </DialogContent>
